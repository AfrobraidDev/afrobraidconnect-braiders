            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between p-6 sm:p-10 lg:p-16">
                ...
                <main className="flex-grow flex flex-col justify-center max-w-md mx-auto md:mx-0 py-10">
                    ...
                    <form onSubmit={handleCredentialsSignIn} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-sm font-semibold text-gray-800 mb-2">
                                ...
                                <input
                                    ...
                                    className={`w-full py-2 pl-10 pr-3 border ${emailError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-[#c2825d] focus:border-[#b5734c] outline-none text-gray-900`}
                                    required
                                />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                className="w-full py-2 pl-10 pr-3 border border-gray-300 rounded-lg focus:ring-[#c2825d] focus:border-[#b5734c] outline-none text-gray-900"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full px-4 py-3 font-semibold text-white bg-[#b5734c] rounded-lg hover:bg-[#b47550] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#b47550] disabled:bg-[#b5734c]"
                            >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-full py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-gray-700 font-semibold hover:bg-gray-50 transition duration-150 mb-6"
                    >
                    ...
                    <p className="text-center text-sm text-gray-600 mt-8">
                        ...
                        <Link href="/register" className="text-[#b5734c] font-medium hover:underline ml-1">
                            Sign Up as a Professional
                        </Link>
                    </p>
                    <p className="text-center text-sm text-gray-600 mt-8">
                        Haven&apos;t verified my account?{" "}
                        <Link href="/resend-verification" className="text-[#b5734c] font-medium hover:underline ml-1">
                            Revalidate
                        </Link>
                    </p>
                </main>
