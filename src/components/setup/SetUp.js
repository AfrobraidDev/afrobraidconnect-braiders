...
import { Mail, Globe, ChevronDown, ChevronRight } from 'lucide-react';
...
const RoleCard = ({ title, description, role, iconSrc, onSelect }) => (
    <button
        ...
        className="flex items-center justify-between p-4 border border-gray-200 hover:border-[#b5734c] hover:shadow-md transition duration-200 w-full text-left bg-white"
    >
