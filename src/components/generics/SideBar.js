  ...
  <div className="flex flex-col justify-between h-full p-4 text-black">
    ...
    <div>
      <div className="flex items-center mb-10 pl-2">
        <Image src="/images/setuplogo.png" alt="Logo" width={500} height={500} className="h-10 w-auto" />
      </div>
      <ul className="space-y-2">
        <NavLink href="/dashboard" icon={LayoutDashboard} active>Dashboard</NavLink>
        <NavLink href="/dashboard/bookings" icon={CalendarDays}>Bookings</NavLink>
        <NavLink href="/dashboard/clients" icon={Users}>Clients</NavLink>
        <NavLink href="/dashboard/earnings" icon={Wallet}>Earnings</NavLink>
        <NavLink href="/dashboard/portfolio" icon={GalleryVertical}>Portfolio</NavLink>
      </ul>
    </div>
  ...
  return (
    <>
      ...
      <header className="md:hidden flex justify-between items-center p-4 text-white bg-[#b5734c] sticky top-0 z-20">
        <Image src="/images/setuplogo.png" alt="Logo" width={500} height={500} className="h-8 w-auto" />
